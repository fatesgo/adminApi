...
public interface ChatMapper {
    ...
    @Insert("INSERT INTO  chat (to_userId,from_userId,type,content) VALUES (#{to_userId},#{from_userId},#{type},#{content})")
    @Options(useGeneratedKeys=true, keyProperty="id", keyColumn="id")
    int addChatMessage(String to_userId,String from_userId,String type,String content);
